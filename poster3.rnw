...
\end{table}
      ...
      \end{block}
      \vskip2ex
      \begin{block}{Analysis Strategies}
        \rmfamily{
        \begin{itemize} 
...
\begin{block}{Model for Simulated Data}
\rmfamily{
...
\begin{block}{Parameters Used for Simulation}
\rmfamily{
\begin{itemize}
...
\end{block}
\begin{block}{Simulated Slope Coefficients}
\rmfamily{
\begin{itemize}
...
\begin{block}{Testing for Trt and Cov Effects}
\rmfamily{
\begin{itemize}
...
\end{block}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{block}{Methods for Identification of DEG}
\rmfamily{
...
\end{block}
        ...
        \end{column}
        \begin{column}{\onecolwid}\vspace{-.69in}
              \begin{block}{Evaluation of Methods}
      \rmfamily{
      \begin{itemize}
...
@
      ...
      \begin{block}{Comments on the Results and Conclusions}
          \rmfamily{
\begin{itemize}
